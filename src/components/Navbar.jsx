...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  //tooltipComponent display informative text when user hovers over focus on or tap an element.
  <TooltipComponent content={title} position="BottomCenter">
    ...
    >
      {/*span is an inline container used to markup a part of text or docuent.*/}
      <span
...
const Navbar = () => {
  ...
  //useEffect is when you tell react that your component needs to do something after render..
